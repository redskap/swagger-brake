...
public class SwaggerBreaker {
    public static void main(String[] args) {
        AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(CoreConfiguration.class, RunnerConfiguration.class, CliConfiguration.class);
